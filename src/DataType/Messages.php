...
class Messages
{
    ...
    public const BAD_TYPE_FOR_INT_PROCESS_RULE = "Rule %s can only process integers";
    public const BAD_TYPE_FOR_FLOAT_PROCESS_RULE = "Rule %s can only process floats";
    ...
    public const VALUE_MUST_BE_GREATER_OR_EQUAL_TO_PARAM = "Value must be greater than or equal to parameter '%s'.";
