...
/**
 * Tri-state optional bool: absent, explicit null, or present value (then cast/process rules apply).
 */
class GetOptionalNullableBool implements ExtractRule
{
    public function process(
        ...
        $castToBool = new CastToBool();

        return $castToBool->process(
