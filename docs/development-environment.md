...
docker exec datatype-developing_8_5-1 bash -c "sh runBehat.sh"

# Run PHPStan
docker exec datatype-developing_8_5-1 bash -c "sh runPhpStan.sh"

# Run Composer commands
docker exec datatype-developing_8_5-1 bash -c "composer install"

# Run PHP CLI commands
docker exec datatype-developing_8_5-1 bash -c "php cli.php <command>"

# Run mutation testing
docker exec datatype-developing_8_5-1 bash -c "sh runMutationTests.sh"
```
...
```bash
# PHP container
docker exec -it datatype-developing_8_5-1 bash
...
```bash
# Run Jest tests
docker exec datatype-developing_8_5-1 bash -c "npm run test"

# Run npm commands
docker exec datatype-developing_8_5-1 bash -c "npm install"
docker exec datatype-developing_8_5-1 bash -c "npm run build"

# Check TypeScript compilation logs after editing TypeScript files
docker logs datatype-developing_8_5-1 --tail 100
```
